    ...
    return (
        <div className={`${C1.backg}`}>
            ...
            <div className={`${C1.swiperwrap}`}>
                <Swiper modules={[Controller,Pagination,Navigation]} pagination={{clickable:true}} onSwiper={setfirstswiper} navigation={true} controller={{control: secondswiper}} className={`${C1.regionswiper} reswiper`}>
                    {
